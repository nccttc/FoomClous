...
2. 创建“新注册”，受支持的帐户类型不要选择 **仅限个人账户** 
3. **重定向 URI** 选择 `Web或者公共` 并填写：`https://您的域名/api/storage/onedrive/callback`。
4. 获取 **Client ID** 和 **Tenant ID**。
5. 在“证书和密码”中生成 **Client Secret**。
...
3. 在 **“已获授权的网域”** 填入您自己的域名。(填主域名：如果你的前端是 cloud.abc.com，后端 API 是 api.abc.com，你只需要填 abc.com 即可。)
4. 点击 **“保存并继续”**。
